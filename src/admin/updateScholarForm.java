...
public class updateScholarForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sc_id.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sc_idActionPerformed(evt);
            }
        });
        ...
        jPanel20.add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 380, 120, 40));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
          if(sc_name.getText().isEmpty()|| sc_type.getText().isEmpty()
            || sc_des.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"All Fields are Required!");
        }else{
        
        
        dbConnector dbc= new dbConnector();
       dbc.updateData("UPDATE tbl_scholarship SET scholarship_status='"+sc_status.getSelectedItem()+"'");
    ...
    private void sc_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sc_idActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sc_idActionPerformed
